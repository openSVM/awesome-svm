...
See `[tests/x402_integration.rs](https://github.com/openSVM/solana-mcp-server)` for complete integration test examples demonstrating:
- Payment Required response
